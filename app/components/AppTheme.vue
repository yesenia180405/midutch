<script setup>
const themes = [
  { id: 1, title: "Games", icon: "/icons/gaming.svg" },
  { id: 2, title: "IRL", icon: "/icons/irl.svg" },
  { id: 3, title: "Music & DJs", icon: "/icons/music.svg" },
  { id: 4, title: "Creative", icon: "/icons/creative.svg" },
  { id: 5, title: "Esports", icon: "/icons/esports.svg" }
];
</script>
<template>
